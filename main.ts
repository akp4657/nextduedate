    ...
    */
    ...
    payDay: Date, hasDirectDeposit: boolean): Date {
        ...
        do {
            ...
            // match the dates in the array directly against dueDate with getTime(). 
            // getTime() is the most precise date function and this seems to do the job.
...
const holidays: Date[] = [new Date('2025-01-01'), new Date('2024-10-31'), new Date('2024-07-09')];
